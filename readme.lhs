...
So, starting at the pointy end of a new project, I aligned my workflow with stack, and started looking at a reproducible, exact startup routine.  I got to stack templates and wrote my own, which was kindy accepted by the crew.
...
- haddock. I will never ever learn haddock.
...
This design must be monadic cause I seem to get a hyper-efficient workflow for free! As an example, I use the following command to build, run, and render readme.lhs as html.
